...
CASES_KB_COLLECTION = "cases_knowledge_base"  # Collection específica para base de conhecimento de casos
...
class CaseKnowledgeIngestor:
    """Converte texto em embedding e armazena no Qdrant - versão para base de conhecimento de casos."""

    def __init__(self, collection_name: str = CASES_KB_COLLECTION):
