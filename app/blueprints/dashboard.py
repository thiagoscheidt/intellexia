...
from app.services.fap_digest_service import (
...
def dashboard():
    ...
    try:
        ...
        latest_dou_contestacoes = build_latest_dou(law_firm_id, limit=20)
        latest_cadastro_contestacoes = build_latest_cadastro(law_firm_id, limit=20)
